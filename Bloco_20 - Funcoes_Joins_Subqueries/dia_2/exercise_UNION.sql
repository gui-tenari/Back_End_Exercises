...
-- exibindo os nomes que contêm a palavra "tracy" na tabela customer e os que contêm "je" na tabela actor .
...
-- 4. Você quer exibir uma lista paginada com os nomes e sobrenomes de todos os clientes e atores
-- do banco de dados, em ordem alfabética. Considere que a paginação está sendo feita de 15 em 15 resultados
...
FROM
    sakila.actor
ORDER BY `full_name`
LIMIT 60) ORDER BY `full_name` LIMIT 15
OFFSET 45;
